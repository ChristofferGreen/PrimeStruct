...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 25i32") {
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 25i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 26i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 27i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 28i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 28i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 29i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 30i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 31i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 5i32") {
  const std::string source = R"(
