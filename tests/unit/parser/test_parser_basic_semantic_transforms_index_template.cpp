...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 13i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 14i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 14i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 15i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 16i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 17i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 17i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 18i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 19i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 20i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 20i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 21i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform method-call after nested indexed template body chain through 22i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform field-access after nested indexed template body chain through 22i32") {
  const std::string source = R"(
...
TEST_CASE(
    "parses semantic transform indexing after nested indexed template body chain through 23i32") {
  const std::string source = R"(
