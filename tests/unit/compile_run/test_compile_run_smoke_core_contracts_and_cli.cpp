...
TEST_CASE("canonical gfx helpers remain behind private substrate boundary") {
  ...
  CHECK(gfxStdlib.find("createWindow([/std/gfx/SubstrateWindowConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("createDevice([/std/gfx/SubstrateDeviceConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("createQueue([/std/gfx/SubstrateDeviceConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("createSwapchain([/std/gfx/SubstrateSwapchainConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("createMesh([/std/gfx/SubstrateMeshConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("createPipeline([/std/gfx/SubstratePipelineConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("acquireFrame([/std/gfx/SubstrateFrameConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("openRenderPass([/std/gfx/SubstrateRenderPassConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("drawMesh([/std/gfx/SubstrateDrawMeshConfig] config)") != std::string::npos);
  CHECK(gfxStdlib.find("endRenderPass([/std/gfx/SubstrateRenderPassEndConfig] config)") != std::string::npos);
