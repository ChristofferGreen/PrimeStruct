...
TEST_CASE("C++ emitter materializes variadic borrowed map packs with indexed count_ref calls") {
  const std::string source = R"(
...
forward_mixed([args<Reference<map<i32, i32>>>] values) {
  [map<i32, i32>] extra{map<i32, i32>(1i32, 2i32)}
  return(score_refs(location(extra), [spread] values))
}

[return<int> effects(heap_alloc)]
main() {
  [map<i32, i32>] a0{map<i32, i32>(1i32, 2i32, 3i32, 4i32)}
  [map<i32, i32>] a1{map<i32, i32>(5i32, 6i32)}
  [map<i32, i32>] a2{map<i32, i32>(7i32, 8i32, 9i32, 10i32, 11i32, 12i32)}
  [map<i32, i32>] b0{map<i32, i32>(13i32, 14i32)}
  [map<i32, i32>] b1{map<i32, i32>(15i32, 16i32, 17i32, 18i32)}
  [map<i32, i32>] b2{map<i32, i32>(19i32, 20i32)}
  [map<i32, i32>] c0{map<i32, i32>(21i32, 22i32, 23i32, 24i32)}
  [map<i32, i32>] c1{map<i32, i32>(25i32, 26i32, 27i32, 28i32, 29i32, 30i32)}
