...
TEST_CASE("ir lowerer call helpers keep explicit map helpers out of native builtin emission") {
  ...
  expectDispatch("/std/collections/map/at_unsafe",
                 ...
                 Result::NotHandled,
                 "stale");
  expectDispatch("/std/collections/experimental_map/mapAt__td48f7c0fb764e3c0",
                 {mapName, keyName},
                 Result::Emitted,
                 "stale");
  expectDispatch("/std/collections/experimental_map/mapAtUnsafe__td48f7c0fb764e3c0",
                 {mapName, keyName},
                 Result::Emitted,
                 "stale");
