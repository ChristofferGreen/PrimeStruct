...
TEST_CASE("compiles and runs experimental stdlib map helper imports in C++ emitter") {
  const std::string source = R"(
...
main() {
  ...
  const std::string srcPath = writeTemp("compile_experimental_stdlib_map_helpers.prime", source);
  const std::string exePath =
      (std::filesystem::temp_directory_path() / "primec_experimental_stdlib_map_helpers_exe").string();
...
TEST_CASE("compiles and runs experimental stdlib map extended constructor parity in C++ emitter") {
  const std::string source = R"(
import /std/collections/experimental_map/*
...
main() {
  ...
  const std::string srcPath = writeTemp("compile_experimental_stdlib_map_extended_ctor_parity.prime", source);
  const std::string exePath =
      (std::filesystem::temp_directory_path() / "primec_experimental_stdlib_map_extended_ctor_parity_exe").string();
