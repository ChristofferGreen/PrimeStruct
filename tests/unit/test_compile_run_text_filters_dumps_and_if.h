...
execute_repeat(count(wrapMap(), 1i32, 2i32), wrapVector().capacity(1i32, 2i32))
)";
  const std::string srcPath =
...
execute_repeat(count(wrapMap()), wrapVector().capacity())
)";
  const std::string srcPath =
...
execute_repeat(wrapVector().capacity(), count(wrapMap()))
)";
  const std::string srcPath = writeTemp(
...
execute_repeat(wrapMap().count(), wrapVector().capacity())
)";
  const std::string srcPath =
...
execute_repeat(wrapVector().capacity(), wrapMap().count())
)";
  const std::string srcPath = writeTemp(
...
execute_repeat(wrapMap().count(true), wrapVector().capacity(true))
)";
  const std::string srcPath =
...
execute_repeat(wrapVector().capacity(true), wrapMap().count(true))
)";
  const std::string srcPath =
      writeTemp("primec_collect_diagnostics_semantic_intra_execution_wrapper_temp_method_count_capacity_pair_type_"
                "reverse_shadow.prime",
                source);
  const std::string errPath =
      (std::filesystem::temp_directory_path() /
...
execute_repeat(wrapVector().capacity(true), wrapMap().count(true))
  ...
  const std::string srcPath =
      writeTemp("primevm_collect_diagnostics_semantic_intra_execution_wrapper_temp_method_count_capacity_pair_type_"
                "reverse_shadow.prime",
                source);
  const std::string errPath =
      (std::filesystem::temp_directory_path() /
...
execute_repeat(wrapMap().count(true), wrapVector().capacity())
)";
  const std::string srcPath = writeTemp(
...
execute_repeat(wrapMap().count(), wrapVector().capacity(true))
)";
  const std::string srcPath =
      writeTemp("primec_collect_diagnostics_semantic_intra_execution_wrapper_temp_method_count_capacity_pair_"
                "mixed_shape_reverse_shadow.prime",
                source);
  const std::string errPath =
      (std::filesystem::temp_directory_path() /
...
execute_repeat(wrapMap().count(), wrapVector().capacity(true))
  ...
  const std::string srcPath =
      writeTemp("primevm_collect_diagnostics_semantic_intra_execution_wrapper_temp_method_count_capacity_pair_"
                "mixed_shape_reverse_shadow.prime",
                source);
  const std::string errPath =
      (std::filesystem::temp_directory_path() /
...
execute_repeat(count(wrapMap(), true), wrapVector().count(true))
)";
  const std::string srcPath =
