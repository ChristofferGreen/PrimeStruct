...
TEST_CASE("ir serialization schema golden fixture stays stable") {
  primec::IrModule module;
  module.entryIndex = 0;
  module.stringTable.push_back("hello");

  primec::IrStructLayout pairLayout;
  pairLayout.name = "/Pair";
  pairLayout.totalSizeBytes = 8;
  pairLayout.alignmentBytes = 4;
  pairLayout.fields.push_back({"left",
                               "i32",
                               0,
                               4,
                               4,
                               primec::IrStructPaddingKind::None,
                               primec::IrStructFieldCategory::Pod,
                               primec::IrStructVisibility::Public,
                               false});
  pairLayout.fields.push_back({"right",
                               "i32",
                               4,
                               4,
                               4,
                               primec::IrStructPaddingKind::None,
                               primec::IrStructFieldCategory::Default,
                               primec::IrStructVisibility::Private,
                               true});
  module.structLayouts.push_back(pairLayout);

  primec::IrFunction mainFn;
  mainFn.name = "/main";
  mainFn.metadata.effectMask = primec::EffectIoOut;
  mainFn.metadata.capabilityMask = primec::EffectIoOut | primec::EffectHeapAlloc;
  mainFn.metadata.instrumentationFlags = primec::InstrumentationTailExecution;
  mainFn.localDebugSlots.push_back({0u, "pair", "/Pair"});
  mainFn.instructions.push_back({primec::IrOpcode::PushI32, 7, 101});
  mainFn.instructions.push_back(
      {primec::IrOpcode::PrintString,
       primec::encodePrintStringImm(0, primec::encodePrintFlags(true, false)),
       102});
  mainFn.instructions.push_back({primec::IrOpcode::ReturnI32, 0, 103});

  primec::IrFunction helperFn;
  helperFn.name = "/helper";
  helperFn.instructions.push_back({primec::IrOpcode::PushI32, 3, 201});
  helperFn.instructions.push_back({primec::IrOpcode::ReturnI32, 0, 202});
  ...
  const std::vector<uint8_t> expected = {
      0x52, 0x49, 0x53, 0x50, 0x17, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
      ...
      };
  ...
  REQUIRE(primec::deserializeIr(data, decoded, error));
  CHECK(error.empty());
  CHECK(decoded.schemaVersion == primec::IrSchemaVersion);
  CHECK(decoded.functions.size() == 2u);
  REQUIRE(decoded.stringTable.size() == 1u);
  CHECK(decoded.stringTable[0] == "hello");
...
TEST_CASE("ir deserialization rejects unsupported version") {
  ...
  const uint32_t unsupportedVersion = primec::IrSchemaVersion + 1u;
  writeU32(4, unsupportedVersion);

  primec::IrModule decoded;
  CHECK_FALSE(primec::deserializeIr(data, decoded, error));
  CHECK(error == "unsupported IR schema version " + std::to_string(unsupportedVersion) +
                     " (supported " + std::to_string(primec::IrSchemaVersion) + ")");
}
