...
forward_mixed([args<Reference<map<i32, i32>>>] values) {
  ...
  [Reference<map<i32, i32>>] extra_ref{location(extra)}
  return(score_refs(extra_ref, [spread] values))
}
...
main() {
  ...
  [Reference<map<i32, i32>>] r0{location(a0)}
  [Reference<map<i32, i32>>] r1{location(a1)}
  [Reference<map<i32, i32>>] r2{location(a2)}
  ...
  [Reference<map<i32, i32>>] s0{location(b0)}
  [Reference<map<i32, i32>>] s1{location(b1)}
  [Reference<map<i32, i32>>] s2{location(b2)}

  [map<i32, i32>] c0{map<i32, i32>(21i32, 22i32, 23i32, 24i32)}
  [map<i32, i32>] c1{map<i32, i32>(25i32, 26i32, 27i32, 28i32, 29i32, 30i32)}
  [Reference<map<i32, i32>>] t0{location(c0)}
  [Reference<map<i32, i32>>] t1{location(c1)}
