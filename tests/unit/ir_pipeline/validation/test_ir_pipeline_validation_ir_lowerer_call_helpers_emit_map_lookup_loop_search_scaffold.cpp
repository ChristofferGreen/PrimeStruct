...
TEST_CASE("ir lowerer call helpers emit array vector access load") {
  ...
  CHECK(instructions[6].op == primec::ir_lowerer::pushZeroForIndex(Kind::Int32));
  CHECK(instructions[7].op == primec::ir_lowerer::cmpLtForIndex(Kind::Int32));
  CHECK(instructions[8].op == primec::IrOpcode::JumpIfZero);
  CHECK(instructions[8].imm == 9);
  CHECK(instructions[9].op == primec::IrOpcode::LoadLocal);
  ...
  CHECK(instructions[10].op == primec::IrOpcode::LoadLocal);
  CHECK(instructions[10].imm == 30);
  CHECK(instructions[11].op == primec::ir_lowerer::cmpGeForIndex(Kind::Int32));
  CHECK(instructions[12].op == primec::IrOpcode::JumpIfZero);
  CHECK(instructions[12].imm == 13);
  CHECK(instructions[13].op == primec::IrOpcode::LoadLocal);
  CHECK(instructions[13].imm == 8);
  CHECK(instructions[14].op == primec::IrOpcode::PushI64);
  CHECK(instructions[14].imm == 48);
  CHECK(instructions[15].op == primec::IrOpcode::AddI64);
  CHECK(instructions[16].op == primec::IrOpcode::LoadIndirect);
  CHECK(instructions[17].op == primec::IrOpcode::StoreLocal);
  CHECK(instructions[17].imm == 31);
  CHECK(instructions[18].op == primec::IrOpcode::LoadLocal);
  CHECK(instructions[18].imm == 31);
  CHECK(instructions[19].op == primec::IrOpcode::LoadLocal);
  CHECK(instructions[19].imm == 9);
  CHECK(instructions[20].op == primec::ir_lowerer::pushOneForIndex(Kind::Int32));
  CHECK(instructions[20].imm == primec::IrSlotBytesI32);
  CHECK(instructions[21].op == primec::ir_lowerer::mulForIndex(Kind::Int32));
  CHECK(instructions[22].op == primec::IrOpcode::AddI64);
  CHECK(instructions[23].op == primec::IrOpcode::LoadIndirect);
