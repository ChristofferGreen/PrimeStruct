...
main() {
  ...
  CHECK(storageChunk.transforms[0].name.rfind("/std/collections/soa_storage/SoaColumns2", 0) == 0);
  ...
  CHECK(storageCountHelper->returnExpr->name.rfind(
            "/std/collections/soa_storage/soaColumns2Count", 0) == 0);
...
main() {
  ...
  CHECK(firstChunk.transforms[0].name.rfind("/std/collections/soa_storage/SoaColumns16", 0) == 0);
  CHECK(firstChunk.transforms[0].templateArgs.empty());
  CHECK(secondChunk.transforms[0].name.rfind("/std/collections/soa_storage/SoaColumn", 0) == 0);
  ...
  REQUIRE(storageCountHelper->returnExpr.has_value());
  CHECK(storageCountHelper->returnExpr->name.rfind(
            "/std/collections/soa_storage/soaColumns16Count", 0) == 0);
  REQUIRE(storageCapacityHelper->returnExpr.has_value());
  CHECK(storageCapacityHelper->returnExpr->name.rfind(
