...
void populatePublishedFactFormatterStrings(primec::SemanticProgram &semanticProgram) {
  semanticProgram.directCallTargets.push_back(primec::SemanticProgramDirectCallTarget{
      .scopePath = "/raw/direct",
      .callName = "rawDirect"});

  semanticProgram.methodCallTargets.push_back(primec::SemanticProgramMethodCallTarget{
      .scopePath = "/raw/method",
      .methodName = "rawMethod",
      .receiverTypeText = "RawReceiver"});

  primec::SemanticProgramBridgePathChoice bridgeChoice;
  bridgeChoice.scopePath = "/raw/bridge";
  bridgeChoice.collectionFamily = "RawCollectionFamily";
  semanticProgram.bridgePathChoices.push_back(std::move(bridgeChoice));

  primec::SemanticProgramCallableSummary callableSummary;
  callableSummary.returnKind = "RawCallableReturn";
  callableSummary.activeEffects = {"RawEffect"};
  callableSummary.activeCapabilities = {"RawCapability"};
  callableSummary.resultValueType = "RawCallableValue";
  callableSummary.resultErrorType = "RawCallableError";
  callableSummary.onErrorHandlerPath = "/raw/handler";
  callableSummary.onErrorErrorType = "RawHandlerError";
  semanticProgram.callableSummaries.push_back(std::move(callableSummary));

  primec::SemanticProgramCollectionSpecialization collectionSpecialization;
  collectionSpecialization.scopePath = "/raw/collection";
  collectionSpecialization.siteKind = "RawSiteKind";
  collectionSpecialization.name = "rawCollection";
  collectionSpecialization.collectionFamily = "RawCollection";
  collectionSpecialization.bindingTypeText = "RawCollectionBinding";
  collectionSpecialization.elementTypeText = "RawCollectionElement";
  collectionSpecialization.keyTypeText = "RawCollectionKey";
  collectionSpecialization.valueTypeText = "RawCollectionValue";
  semanticProgram.collectionSpecializations.push_back(std::move(collectionSpecialization));

  primec::SemanticProgramBindingFact bindingFact;
  bindingFact.scopePath = "/raw/binding";
  bindingFact.siteKind = "RawBindingSite";
  bindingFact.name = "rawBinding";
  bindingFact.bindingTypeText = "RawBindingType";
  bindingFact.referenceRoot = "rawReference";
  semanticProgram.bindingFacts.push_back(std::move(bindingFact));

  primec::SemanticProgramReturnFact returnFact;
  returnFact.returnKind = "RawReturnKind";
  returnFact.structPath = "/raw/Struct";
  returnFact.bindingTypeText = "RawReturnType";
  returnFact.referenceRoot = "rawReturnReference";
  semanticProgram.returnFacts.push_back(std::move(returnFact));
}

void indexPublishedFactFormatterStrings(primec::SemanticProgram &semanticProgram) {
  auto &directCall = semanticProgram.directCallTargets.front();
  directCall.scopePathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/direct");
  directCall.callNameId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedDirect");
  directCall.resolvedPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/direct/target");

  auto &methodCall = semanticProgram.methodCallTargets.front();
  methodCall.scopePathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/method");
  methodCall.methodNameId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedMethod");
  methodCall.receiverTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedReceiver");
  methodCall.resolvedPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/method/target");

  auto &bridgeChoice = semanticProgram.bridgePathChoices.front();
  bridgeChoice.scopePathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/bridge");
  bridgeChoice.collectionFamilyId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollectionFamily");
  bridgeChoice.helperNameId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedHelper");
  bridgeChoice.chosenPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/bridge/target");

  auto &callableSummary = semanticProgram.callableSummaries.front();
  callableSummary.fullPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/callable");
  callableSummary.returnKindId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCallableReturn");
  callableSummary.activeEffectIds = {
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedEffect")};
  callableSummary.activeCapabilityIds = {
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCapability")};
  callableSummary.resultValueTypeId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCallableValue");
  callableSummary.resultErrorTypeId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCallableError");
  callableSummary.onErrorHandlerPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/handler");
  callableSummary.onErrorErrorTypeId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedHandlerError");

  auto &collectionSpecialization = semanticProgram.collectionSpecializations.front();
  collectionSpecialization.scopePathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/collection");
  collectionSpecialization.siteKindId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedSiteKind");
  collectionSpecialization.nameId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedCollection");
  collectionSpecialization.collectionFamilyId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollection");
  collectionSpecialization.bindingTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollectionBinding");
  collectionSpecialization.elementTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollectionElement");
  collectionSpecialization.keyTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollectionKey");
  collectionSpecialization.valueTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedCollectionValue");

  auto &bindingFact = semanticProgram.bindingFacts.front();
  bindingFact.scopePathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/binding");
  bindingFact.siteKindId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedBindingSite");
  bindingFact.nameId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedBinding");
  bindingFact.resolvedPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/binding/target");
  bindingFact.bindingTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedBindingType");
  bindingFact.referenceRootId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedReference");

  auto &returnFact = semanticProgram.returnFacts.front();
  returnFact.definitionPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/return");
  returnFact.returnKindId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedReturnKind");
  returnFact.structPathId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "/mapped/Struct");
  returnFact.bindingTypeTextId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "MappedReturnType");
  returnFact.referenceRootId =
      primec::semanticProgramInternCallTargetString(semanticProgram, "mappedReturnReference");
}

void indexPublishedFactModuleEntries(primec::SemanticProgram &semanticProgram) {
  primec::SemanticProgramModuleResolvedArtifacts module;
  module.identity.moduleKey = "/main";
  module.directCallTargetIndices.push_back(0);
  module.methodCallTargetIndices.push_back(0);
...
TEST_CASE("semantic product fact dumps require interned text after freeze") {
  primec::SemanticProgram mutableSemanticProgram;
  populatePublishedFactFormatterStrings(mutableSemanticProgram);
  indexPublishedFactModuleEntries(mutableSemanticProgram);

  const std::string mutableDump = primec::formatSemanticProgram(mutableSemanticProgram);
  CHECK(mutableDump.find("/raw/direct") != std::string::npos);
  CHECK(mutableDump.find("RawCallableReturn") != std::string::npos);
  CHECK(mutableDump.find("RawCollectionValue") != std::string::npos);
  CHECK(mutableDump.find("RawReturnType") != std::string::npos);

  primec::SemanticProgram rawFrozenSemanticProgram;
  populatePublishedFactFormatterStrings(rawFrozenSemanticProgram);
  indexPublishedFactModuleEntries(rawFrozenSemanticProgram);
  primec::freezeSemanticProgramPublishedStorage(rawFrozenSemanticProgram);

  const std::string rawFrozenDump = primec::formatSemanticProgram(rawFrozenSemanticProgram);
  CHECK(rawFrozenDump.find("direct_call_targets[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("method_call_targets[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("bridge_path_choices[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("callable_summaries[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("collection_specializations[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("binding_facts[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("return_facts[0]") != std::string::npos);
  CHECK(rawFrozenDump.find("/raw/direct") == std::string::npos);
  CHECK(rawFrozenDump.find("RawCallableReturn") == std::string::npos);
  CHECK(rawFrozenDump.find("RawCollectionValue") == std::string::npos);
  CHECK(rawFrozenDump.find("RawReturnType") == std::string::npos);

  primec::SemanticProgram mappedSemanticProgram;
  populatePublishedFactFormatterStrings(mappedSemanticProgram);
  indexPublishedFactFormatterStrings(mappedSemanticProgram);
  indexPublishedFactModuleEntries(mappedSemanticProgram);
  primec::freezeSemanticProgramPublishedStorage(mappedSemanticProgram);

  const std::string mappedDump = primec::formatSemanticProgram(mappedSemanticProgram);
  CHECK(mappedDump.find("/mapped/direct") != std::string::npos);
  CHECK(mappedDump.find("MappedCallableReturn") != std::string::npos);
  CHECK(mappedDump.find("MappedCollectionValue") != std::string::npos);
  CHECK(mappedDump.find("MappedReturnType") != std::string::npos);
  CHECK(mappedDump.find("/raw/direct") == std::string::npos);
  CHECK(mappedDump.find("RawCallableReturn") == std::string::npos);
  CHECK(mappedDump.find("RawCollectionValue") == std::string::npos);
  CHECK(mappedDump.find("RawReturnType") == std::string::npos);
}
