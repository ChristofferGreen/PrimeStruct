...
TEST_CASE("stdlib File seven-value helpers cover imported method and slash-call wrappers") {
  const std::string source = R"(
import /std/file/*

[effects(file_write), return<void>]
write_out([File<Write>] file) {
  [Result<FileError>] directWrite{/File/write<Write, string, i32, string, i32, string, i32, string>(
      file,
      "alpha"utf8,
      7i32,
      "omega"utf8,
      ...
      9i32,
      "!"utf8)}
  [Result<FileError>] directWriteLine{/File/write_line<Write, i32, string, i32, string, i32, string, i32>(
      file,
      255i32,
      " "utf8,
      0i32,
      ...
      "?"utf8,
      1i32)}
  [Result<FileError>] methodWrite{file.write("left"utf8, 1i32, "mid"utf8, 2i32, "right"utf8, 3i32, "."utf8)}
  [Result<FileError>] methodWriteLine{file.write_line(4i32, " "utf8, 5i32, " "utf8, 6i32, "?"utf8, 7i32)}
  return()
}
...
TEST_CASE("stdlib File eight-value slash-call wrappers remain unresolved") {
  const std::string source = R"(
import /std/file/*

[effects(file_write), return<void>]
write_out([File<Write>] file) {
  /File/write_line<Write, i32, i32, i32, i32, i32, i32, i32, i32>(
      file,
      1i32,
      2i32,
      3i32,
