...
TEST_CASE("todo queue and skipped doctest debt stay source locked") {
  ...
  CHECK(todo.find("| Stdlib de-experimentalization and public/internal namespace cleanup | TODO-4430, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| SoA maturity and `soa` public-surface rename | TODO-4305, TODO-4306, TODO-4514, TODO-4516, TODO-4308, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| De-experimentalization surface and namespace parity | TODO-4430, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| `soa` maturity and canonical surface parity | TODO-4305, TODO-4306, TODO-4514, TODO-4516, TODO-4308, TODO-4309, TODO-4310 |") !=
        std::string::npos);
