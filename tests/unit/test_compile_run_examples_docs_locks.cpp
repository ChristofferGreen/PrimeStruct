...
TEST_CASE("soa public collection docs stay source locked") {
  ...
  CHECK(syntaxSpecDoc.find("/std/collections/soa_vector_conversions/*") !=
        std::string::npos);
  CHECK(syntaxSpecDoc.find("coverage for targeted tests rather than ordinary public imports") !=
        std::string::npos);
  CHECK(syntaxSpecDoc.find("promoted public shape for `soa<T>`") !=
        std::string::npos);
  ...
  CHECK(experimentalSoaVector.find(
            "// Accepted compatibility module behind canonical /std/collections/soa/*.") !=
        std::string::npos);
  CHECK(experimentalSoaVector.find(
...
TEST_CASE("legacy soa_vector compatibility backend parity matrix stays source locked") {
...
main() {
  ...
  CHECK(vmParity.find("TEST_CASE(\"vm legacy soa_vector compatibility helpers run without experimental imports\")") !=
        std::string::npos);
  ...
  CHECK(nativeParity.find("TEST_CASE(\"native legacy soa_vector compatibility helpers run without experimental imports\")") !=
        std::string::npos);
...
TEST_CASE("todo queue and skipped doctest debt stay source locked") {
  ...
  CHECK(todo.find("### Ready Now (Live Leaves; No Unmet TODO Dependencies)") !=
        std::string::npos);
  CHECK(todo.find("### Ready Now (Live Leaves; No Unmet TODO Dependencies)\n\n"
                  "- TODO-4517: Lower public SoA field-view wrappers") !=
        std::string::npos);
  ...
  CHECK(todo.find("| Stdlib de-experimentalization and public/internal namespace cleanup | TODO-4430, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| SoA maturity and `soa` public-surface rename | TODO-4305, TODO-4306, TODO-4514, TODO-4517, TODO-4308, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| De-experimentalization surface and namespace parity | TODO-4430, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |") !=
        std::string::npos);
  CHECK(todo.find("| `soa` maturity and canonical surface parity | TODO-4305, TODO-4306, TODO-4514, TODO-4517, TODO-4308, TODO-4309, TODO-4310 |") !=
        std::string::npos);
