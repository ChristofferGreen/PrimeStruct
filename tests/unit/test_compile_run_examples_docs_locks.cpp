...
TEST_CASE("todo queue and skipped doctest debt stay source locked") {
  ...
  CHECK(todo.find("| Semantic ownership boundary and graph/local-auto authority | TODO-4227, TODO-4218, TODO-4231, TODO-4236, TODO-4237, TODO-4238, TODO-4239 |") !=
        std::string::npos);
  ...
  CHECK(todo.find("| `soa_vector` maturity and canonical surface parity | TODO-4244, TODO-4246, TODO-4247, TODO-4248, TODO-4249, TODO-4250, TODO-4251, TODO-4252 |") !=
        std::string::npos);
  CHECK(todo.find("| Validator entrypoint and benchmark-plumbing split | TODO-4227 |") !=
        std::string::npos);
  CHECK(todo.find("| Semantic-product publication by module and fact family | TODO-4227, TODO-4215, TODO-4240, TODO-4241 |") !=
        std::string::npos);
  ...
  CHECK(todo.find("| Architecture contract probe migration | TODO-4221, TODO-4235, TODO-4242 |") !=
        std::string::npos);
  CHECK(todo.find("| Semantic-product publication parity and deterministic ordering | TODO-4227, TODO-4215, TODO-4240 |") !=
        std::string::npos);
