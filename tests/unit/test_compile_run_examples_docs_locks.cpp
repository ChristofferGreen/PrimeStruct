...
TEST_CASE("todo queue and skipped doctest debt stay source locked") {
  ...
  CHECK(todo.find("### Priority Lanes (Current)\n\n"
                  "- Semantic phase contract hardening: TODO-4215 -> TODO-4228") !=
        std::string::npos);
  CHECK(todo.find("  -> TODO-4217 -> TODO-4224 -> TODO-4229 -> TODO-4230") !=
        std::string::npos);
  ...
  CHECK(todo.find("| Validator entrypoint and benchmark-plumbing split | none |") !=
        std::string::npos);
  CHECK(todo.find("| Semantic-product publication by module and fact family | TODO-4215, TODO-4240, TODO-4241 |") !=
        std::string::npos);
  ...
  CHECK(todo.find("| Architecture contract probe migration | TODO-4221, TODO-4235, TODO-4242 |") !=
        std::string::npos);
  CHECK(todo.find("| Semantic-product publication parity and deterministic ordering | TODO-4215, TODO-4240 |") !=
        std::string::npos);
