...
addPrimeStructManagedDoctestSuite("primestruct.compile.run.vm.core"
                                  ...
                                  RANGE_FIRST 25
                                  RANGE_LAST 28)
# TODO-4711: measured ~22.1s real worst case for this shard; 90s = ~3x
# margin (see TODO-4710/TODO-5230 for the per-compile subprocess cost root
# cause).
addPrimeStructManagedDoctestSuite("primestruct.compile.run.vm.core"
                                  TIMEOUT 90
...
# TODO-4711: measured ~46.4s real worst case for this shard; 150s = ~3x
# margin, still above the 30s ceiling (see TODO-4710/TODO-5230 for the
# per-compile subprocess cost root cause).
addPrimeStructManagedDoctestSuite("primestruct.compile.run.vm.core"
                                  TIMEOUT 150
...
addPrimeStructManagedDoctestSuite("primestruct.compile.run.vm.collections"
                                  ...
                                  RANGE_FIRST 332
                                  RANGE_LAST 352)
# TODO-4711: this range's slowest shard measured ~53.9s real wall-clock;
# 180s = ~3x margin, still above the 30s ceiling (see TODO-4710/TODO-5230
# for the per-compile subprocess cost root cause).
addPrimeStructManagedDoctestSuite("primestruct.compile.run.vm.collections"
                                  TIMEOUT 180
