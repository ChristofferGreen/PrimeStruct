...
ALLOWED_MAX_COUNTS: dict[tuple[str, str], int] = {
    ...
    ("src/ir_lowerer/IrLowererAccessTargetResolution.cpp", "experimental-map-path"): 5,
    ("src/ir_lowerer/IrLowererAccessTargetResolution.cpp", "map-backing-type-symbol"): 1,
