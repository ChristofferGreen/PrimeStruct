...
ALLOWED_MAX_FILE_COUNTS: dict[str, int] = {
    ...
    "src/emitter/EmitterBuiltinCollectionInferenceHelpers.cpp": 2,
    ...
    "src/emitter/EmitterExprCollectionFallbackHelpers.h": 1,
    "src/emitter/EmitterExprCollectionTypeHelpers.h": 10,
    "src/emitter/EmitterHelpers.h": 2,
    "src/emitter/EmitterHelpersStructTypes.cpp": 2,
    ...
    "src/ir_lowerer/IrLowererSetupTypeReturnKindHelpers.cpp": 1,
    ...
    "src/semantics/SemanticsValidatorBuildDirectCallBinding.cpp": 2,
    ...
    "src/semantics/SemanticsValidatorExpr.cpp": 1,
    ...
    "src/semantics/SemanticsValidatorExprBuiltinContextSetup.cpp": 1,
    "src/semantics/SemanticsValidatorExprCallResolution.cpp": 13,
    "src/semantics/SemanticsValidatorExprCollectionAccess.cpp": 87,
    "src/semantics/SemanticsValidatorExprCollectionAccessValidation.cpp": 35,
    ...
    "src/semantics/SemanticsValidatorExprNamedArgumentBuiltins.cpp": 1,
    ...
    "src/semantics/SemanticsValidatorInferTargetResolution.cpp": 1,
    ...
    "src/semantics/SemanticsValidatorStatementContainerHelpers.cpp": 2,
    ...
    "src/semantics/TemplateMonomorphExperimentalCollectionTypeHelpers.h": 2,
    "src/semantics/TemplateMonomorphExpressionRewrite.h": 32,
    "src/semantics/TemplateMonomorphFallbackTypeInference.h": 16,
    "src/semantics/TemplateMonomorphImplicitTemplateInference.h": 2,
    "src/semantics/TemplateMonomorphMethodTargets.h": 3,
    "src/semantics/TemplateMonomorphTypeResolution.h": 5,
}
