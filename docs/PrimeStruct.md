...
- **Float note:** VM/native lowering supports float literals, bindings, arithmetic, comparisons, and numeric conversions; float-heavy math helpers like `/math/fma`, `/math/hypot`, and `/math/copysign` still require the C++ emitter.
