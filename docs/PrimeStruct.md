...
probes across count/capacity builtin validation, method-target,
infer-time helper-shadow, vector-helper routing, preferred-target
selection, and return-inference paths,
