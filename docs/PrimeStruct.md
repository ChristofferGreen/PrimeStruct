...
- **Stdlib-owned surface metadata:** canonical vector and map
  ...
  wrapper bridges are rejected or retired, and TODO-4443 deletes the remaining
...
- **Migration-only seams:** rooted `/map/*` spellings plus
  ...
  `mapCount`-style wrapper bridges are retired; TODO-4443 owns the remaining
...
- **Compatibility adapter inventory:** map insert helper compatibility no
  ...
  compatibility diagnostics and lowerer/semantic adapters until TODO-4443
