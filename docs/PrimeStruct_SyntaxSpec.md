...
byte-addressable pointers (a raw pointer reinterpret primitive now exists and
...
can the shared helper path route onto that carrier and preserve it across
pass/return/local-binding surfaces.
