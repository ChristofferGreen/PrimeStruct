...
semantics-helper surface, while direct collection-access and SoA builtin
validation now also share one borrowed experimental receiver probe instead of
keeping duplicated inline lambdas.
