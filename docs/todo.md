...
- ○ Remove the remaining no-import builtin fallback for canonical `/std/collections/vector/*` non-constructor helper spellings once the imported stdlib wrapper path is stable.
