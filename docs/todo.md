...
- ○ Remove the remaining no-import builtin fallback for canonical `/std/collections/vector/at(...)` and `/std/collections/vector/at_unsafe(...)` helper spellings once the imported stdlib wrapper path is stable.
