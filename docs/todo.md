...
- [ ] TODO-4106: Re-enable or prune skipped collection compatibility suites
  ...
  - acceptance:
    ...
    - Docs/todo and adjacent source locks reflect the narrowed collection skip
      surface.
  - notes: Remaining collection skips after the helper-routing re-enable live
      in compile-run coverage such as `test_compile_run_examples_docs.cpp`,
      `test_compile_run_native_backend_core_map_and_vector_variadics.cpp`, and
