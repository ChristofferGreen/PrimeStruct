...
- TODO-4467: Delete experimental-map public helper aliases
...
- Map stdlib ownership cutover: TODO-4467 -> TODO-4468 -> TODO-4464
...
| Stdlib bridge consolidation and collection/file/gfx surface authority | TODO-4430, TODO-4467, TODO-4468, TODO-4464, TODO-4308, TODO-4309, TODO-4310 |
| Vector/map stdlib ownership cutover and collection surface authority | TODO-4430, TODO-4467, TODO-4468, TODO-4464 |
| Stdlib de-experimentalization and public/internal namespace cleanup | TODO-4430, TODO-4467, TODO-4468, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |
...
| Vector/map bridge parity for imports, rewrites, and lowering | TODO-4430, TODO-4467, TODO-4468, TODO-4464 |
| De-experimentalization surface and namespace parity | TODO-4430, TODO-4467, TODO-4468, TODO-4464, TODO-4305, TODO-4309, TODO-4310 |
...
- Migration-only seams: rooted `/map/*` spellings,
  ...
  TODO-4467, TODO-4468, and TODO-4464 continue the same ownership model for map
  ...
  removed from that manifest, and slashless experimental-map helper path
  normalization was deleted.
...
- [ ] TODO-4467: Delete experimental-map public helper aliases
  ...
  - scope: Delete remaining lowerer/emitter recognition of rooted
    `/std/collections/experimental_map/*` helper/member aliases as public map
    method or access helpers, while preserving any explicitly needed internal
    backing definitions.
  - implementation_notes:
    - Use current rooted `experimental_map` helper matches under
      `src/ir_lowerer/` and `src/emitter/` as the inventory.
  ...
  - acceptance:
    - Lowerer/emitter helper selection no longer treats rooted
      `/std/collections/experimental_map/*` access, entry, or method helper
      paths as public map-surface aliases.
    ...
    - Source-lock or behavior coverage rejects reintroducing the removed rooted
      experimental-map public helper aliases.
    - `./scripts/compile.sh --release` passes.
  - stop_rule: Stop once rooted experimental-map helper aliases are gone from
    lowerer/emitter public helper recognition; leave backing type/layout traces
    to TODO-4468.
...
- [ ] TODO-4468: Classify remaining experimental-map backing traces
  ...
  - implementation_notes:
    - Use the TODO-4467 residue plus current `experimental_map` matches under
