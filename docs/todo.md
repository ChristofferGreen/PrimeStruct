...
- TODO-4392: Remove remaining rooted vector semantic shims
...
- Vector stdlib ownership cutover: TODO-4392 -> TODO-4381 -> TODO-4372
  -> TODO-4373
...
| Stdlib bridge consolidation and collection/file/gfx surface authority | TODO-4392, TODO-4381, TODO-4372, TODO-4373, TODO-4302, TODO-4303, TODO-4304, TODO-4308, TODO-4309, TODO-4310 |
| Vector/map stdlib ownership cutover and collection surface authority | TODO-4392, TODO-4381, TODO-4372, TODO-4373, TODO-4299, TODO-4300, TODO-4301, TODO-4302, TODO-4303, TODO-4304 |
| Stdlib de-experimentalization and public/internal namespace cleanup | TODO-4392, TODO-4381, TODO-4372, TODO-4373, TODO-4299, TODO-4303, TODO-4304, TODO-4305, TODO-4309, TODO-4310 |
...
| Vector/map bridge parity for imports, rewrites, and lowering | TODO-4392, TODO-4381, TODO-4372, TODO-4373, TODO-4299, TODO-4301, TODO-4302, TODO-4303, TODO-4304 |
| De-experimentalization surface and namespace parity | TODO-4392, TODO-4381, TODO-4372, TODO-4373, TODO-4299, TODO-4303, TODO-4304, TODO-4305, TODO-4309, TODO-4310 |
...
- Migration-only seams: rooted `/map/*` spellings,
  `mapCount`-style lowering names, and
  ...
  TODO-4392, TODO-4381, TODO-4372, and TODO-4373 handle the remaining
...
- End-state rule for vector: after TODO-4373, production C++ under `src/` and
...
- [ ] TODO-4392: Remove remaining rooted vector semantic shims
  ...
  - scope: Remove remaining rooted `/vector/*` semantic validator shims after
    the direct expression-call, map-count method-target, explicit method
    classification list, statement mutator path-builder duplication, and
    count/capacity unknown-target visibility-check duplication, and expression
    method helper path duplication, and method-target prefix-probe duplication
    paths, and expression mutator method path duplication were deleted,
    and statement mutator rooted path duplication were deleted, without
    changing ordinary user-defined rooted paths or lowerer/emitter dispatch,
    after count/capacity rooted target literals were collapsed, and after
    rooted method-target prefix constants were folded together.
  - implementation_notes:
    - Start from `src/semantics/SemanticsValidatorExpr.cpp`,
    ...
    - Preserve explicit user-defined `/vector/*` definitions as ordinary
      definitions; remove only builtin compatibility routing or diagnostics.
  - acceptance:
...
- [ ] TODO-4381: Remove canonical vector semantic shims
  ...
  - implementation_notes:
    - Start from `src/semantics/SemanticsValidatorExprVectorHelpers.cpp`,
      `src/semantics/SemanticsValidatorStatementVectorHelpers.cpp`,
      `src/semantics/SemanticsValidatorStatementVectorResolution.cpp`, and
    ...
    - Keep canonical user-facing vector helpers working through the stdlib
      surface; remove only production C++ compatibility branches that should be
      owned by generic routing or manifest metadata.
  - acceptance:
    - Semantic validation no longer contains vector-specific canonical helper
      branches that can be delegated to `.prime` helpers, generic collection
      validation, or stdlib-surface metadata.
    - Existing vector construction, helper, mutation, growth, destruction, and
      import conformance remains covered by focused semantics tests.
    - The vector surface trace baseline decreases for semantic files and does
      not increase elsewhere.
  - stop_rule: Stop once semantic canonical vector helper traces that can be
...
- [ ] TODO-4300: Stabilize map lookup and insertion substrate
  ...
  - implementation_notes:
    - Start from `stdlib/std/collections/experimental_map.prime`,
      ...
      TODO-4373, Maybe/Result migration notes in `docs/PrimeStruct.md`, and
