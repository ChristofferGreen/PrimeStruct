...
- ○ Continue `IrLowererLower.cpp` decomposition by extracting the remaining inference body and return/call + operators/statements include fragments into explicit step units while preserving diagnostic + IR snapshots.
