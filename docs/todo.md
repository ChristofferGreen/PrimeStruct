...
- ○ Replace compiler-injected map missing-key runtime abort paths with the standard container error contract once value-carrying `Result` support covers the current backend map value subset.
