...
- ○ Continue `IrLowererLower.cpp` decomposition by extracting the remaining return/call inlining and operators/statements include fragments into explicit step units while preserving diagnostic + IR snapshots.
