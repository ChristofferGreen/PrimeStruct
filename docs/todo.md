...
- ◐ Define `Maybe<T>` (optional value) using uninitialized storage + tag; add docs and tests (stdlib shape added; constructor ergonomics + backend lowering still missing).
