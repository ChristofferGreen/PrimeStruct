...
- ○ Experimental stdlib `vector` ownership/drop cleanup slice: define destruction and overwrite behavior for pointer-backed experimental vector storage once the remaining mutators land.
