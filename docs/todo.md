...
- ○ Remove the remaining no-import builtin fallback for canonical `/std/collections/vector/capacity(...)` helper spelling once the imported stdlib wrapper path is stable.
