...
- ◐ Continue operator fragment split by extracting remaining math/conversion operator fragments into compileable helpers (phase 1 extracted `SaturateRoundingRoots` lowering to `IrLowererOperatorSaturateRoundingRootsHelpers.{h,cpp}`).
