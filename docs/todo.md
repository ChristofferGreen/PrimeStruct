...
- ○ Continue inline-call/return refactor by extracting inline callee statement execution + cleanup/return-jump patching orchestration from `IrLowererLowerInlineCalls.h` into compileable helpers with direct unit coverage.
