...
- Map stdlib ownership cutover: TODO-4453 -> TODO-4304
...
| Stdlib bridge consolidation and collection/file/gfx surface authority | TODO-4430, TODO-4453, TODO-4304, TODO-4308, TODO-4309, TODO-4310 |
| Vector/map stdlib ownership cutover and collection surface authority | TODO-4430, TODO-4453, TODO-4304 |
| Stdlib de-experimentalization and public/internal namespace cleanup | TODO-4430, TODO-4453, TODO-4304, TODO-4305, TODO-4309, TODO-4310 |
...
| Emitter/semantics map-helper parity | TODO-4453, TODO-4304 |
...
| Vector/map bridge parity for imports, rewrites, and lowering | TODO-4430, TODO-4453, TODO-4304 |
| De-experimentalization surface and namespace parity | TODO-4430, TODO-4453, TODO-4304, TODO-4305, TODO-4309, TODO-4310 |
...
| Emitter map-helper canonicalization parity | TODO-4453, TODO-4304 |
...
- Migration-only seams: rooted `/map/*` spellings,
  ...
  TODO-4453 and TODO-4304 continue the same ownership model for map after
...
- Compatibility adapter inventory: map insert helper compatibility no longer
  ...
  removed-map helper classification branches. TODO-4453 owns the remaining
  production C++ adapter-level map compatibility cleanup. Template
...
- [ ] TODO-4453: Delete remaining map raw/lowering adapters
  ...
  - scope: Remove the remaining production C++ compatibility adapters for old
    ...
    struct-return inference and intra-body diagnostics, inline and native
    raw-path dispatch checks, and internal `mapCount`-style lowering names now
    that public wrapper bridge names, template-monomorph path adapters, lowerer
    helper path-candidate adapters, generated experimental-map helper-family
    fallback, semantic struct-return helper path adapters, and intra-body
    rooted-map diagnostic adapters are retired.
  - implementation_notes:
    - Target semantic helper rewrites, inline/native raw-path dispatch checks,
      internal `mapCount` / `mapContains` / `mapTryAt` / `mapAt` /
      `mapInsert` lowering spellings.
