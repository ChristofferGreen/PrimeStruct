...
- Evidence: `EmitterBuiltinCallPathHelpers.cpp` now resolves canonical and
  ...
  key/value names too; pre-dispatch access key/value locals should use
  key/value names too; late call compatibility key/value locals should use
  key/value names too; map/SoA validation key locals should use key/value
  ...
  too; late access diagnostic key parameters should use key/value names
  too; collection access validation value locals should use key/value names
  ...
  too; map/SoA contains-key validator locals should use key/value names too;
  statement printability value-type resolver locals should use key/value names
  ...
  should use key/value names too; method-resolution fallback and visibility
  ...
  key/value names too; infer compatibility wrapper-surface locals should use
  key/value names too; initializer inference constructor predicates should use
  key/value names too; template expression rewrite helper-receiver locals
  should use collection/key-value names too; template expression rewrite
  ...
  substrings when they are not map collection references; packed-result
  literal constructor validity locals should use key/value names too; setup
  type receiver-target reference and pointer classifier locals should use
  ...
  names too; initializer inference constructor template-argument locals should
  ...
  use key/value names too; late access specialized backing and type-text
  ...
  receiver/type helper APIs should use key/value names too; statement
  ...
  use key/value names too; builtin semantic insert receiver binding helpers
...
- Fact: Lowerer locals classify map-shaped collection values with
  ...
  default-expression classifiers, validator count-diagnostic locals,
  argument-validation receiver locals, and resolved-call constructor validators
...
- Fact: Rooted retired public map constructor aliases such as
  ...
  surface ID directly, and published constructor predicates should use
  key/value naming.
