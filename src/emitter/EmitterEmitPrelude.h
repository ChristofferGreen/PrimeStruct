  ...
  out << "}\n";
  out << "struct ps_legacy_result_value {\n";
  out << "  uint32_t error = 0;\n";
  ...
  out << "  operator uint64_t() const {\n";
  out << "    return (static_cast<uint64_t>(error) << 32) | static_cast<uint64_t>(payload);\n";
  out << "  }\n";
  out << "};\n";
  ...
  out << "}\n";
  out << "static inline uint32_t ps_legacy_result_error(ps_legacy_result_value result) {\n";
  out << "  return result.error;\n";
  out << "}\n";
  out << "static inline uint32_t ps_legacy_result_payload(ps_legacy_result_value result) {\n";
  ...
  out << "static inline T ps_try_value(ps_legacy_result_value result, Handler &&handler) {\n";
  out << "  uint32_t err = ps_legacy_result_error(result);\n";
  out << "  if (err != 0) {\n";
  out << "    handler(err);\n";
  out << "    throw ps_result_unwind{err};\n";
  out << "  }\n";
  out << "  return static_cast<T>(ps_legacy_result_payload(result));\n";
  out << "}\n";
  out << "template <typename Handler>\n";
  out << "static inline ps_file_handle ps_try_file(ps_legacy_result_value result, Handler &&handler) {\n";
  out << "  uint32_t err = ps_legacy_result_error(result);\n";
  out << "  if (err != 0) {\n";
  out << "    handler(err);\n";
  out << "    throw ps_result_unwind{err};\n";
  out << "  }\n";
  out << "  return ps_file_handle(static_cast<int>(ps_legacy_result_payload(result)));\n";
  out << "}\n";
  ...
  out << "  return 0;\n";
  out << "}\n";
  out << "static inline ps_legacy_result_value ps_file_open_read(std::string_view path) {\n";
  out << "  std::string pathText(path);\n";
  out << "  int fd = ::open(pathText.c_str(), O_RDONLY);\n";
  out << "  if (fd < 0) {\n";
  out << "    return ps_legacy_result_pack(ps_errno_value(), 0u);\n";
  out << "  }\n";
  out << "  return ps_legacy_result_pack(0u, static_cast<uint32_t>(fd));\n";
  out << "}\n";
  out << "static inline ps_legacy_result_value ps_file_open_write(std::string_view path) {\n";
  out << "  std::string pathText(path);\n";
  ...
  out << "  return ps_legacy_result_pack(0u, static_cast<uint32_t>(fd));\n";
  out << "}\n";
  out << "static inline ps_legacy_result_value ps_file_open_append(std::string_view path) {\n";
  out << "  std::string pathText(path);\n";
