  ...
  out << "}\n";
  out << "static inline uint64_t ps_legacy_result_pack(uint32_t err, uint32_t value) {\n";
  out << "  return (static_cast<uint64_t>(err) << 32) | static_cast<uint64_t>(value);\n";
  out << "}\n";
  out << "static inline uint32_t ps_legacy_result_error(uint64_t result) {\n";
  out << "  return static_cast<uint32_t>(result >> 32);\n";
  out << "}\n";
  out << "static inline uint32_t ps_legacy_result_value(uint64_t result) {\n";
  ...
  out << "  }\n";
  out << "  return static_cast<T>(ps_legacy_result_value(result));\n";
  out << "}\n";
  out << "template <typename Handler>\n";
  ...
  out << "    throw ps_result_unwind{err};\n";
  out << "  }\n";
  out << "  return ps_file_handle(static_cast<int>(ps_legacy_result_value(result)));\n";
  out << "}\n";
