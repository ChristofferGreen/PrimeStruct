  ...
  out << "}\n";
  out << "static inline bool ps_result_is_error(ps_result_value result) {\n";
  out << "  return result.tag != 0u;\n";
  out << "}\n";
  out << "static inline uint32_t ps_result_error_payload(ps_result_value result) {\n";
  out << "  return result.error;\n";
  out << "}\n";
  out << "static inline uint32_t ps_result_payload(ps_result_value result) {\n";
  ...
  out << "  if (ps_result_is_error(result)) {\n";
  out << "    uint32_t err = ps_result_error_payload(result);\n";
  out << "    handler(err);\n";
  out << "    throw ps_result_unwind{err};\n";
  out << "  }\n";
  out << "  return static_cast<T>(ps_result_payload(result));\n";
  out << "}\n";
  out << "template <typename Handler>\n";
  ...
  out << "    throw ps_result_unwind{err};\n";
  out << "  }\n";
  out << "  return ps_file_handle(static_cast<int>(ps_result_payload(result)));\n";
  out << "}\n";
