  ...
  out << "}\n";
  out << "static constexpr uint32_t ps_result_ok_tag = 0u;\n";
  out << "static constexpr uint32_t ps_result_error_tag = 1u;\n";
  ...
  out << "  return ps_result_status{ps_result_ok_tag, 0u};\n";
  out << "}\n";
  out << "static inline ps_result_status ps_result_status_error(uint32_t err) {\n";
  out << "  return ps_result_status{ps_result_error_tag, err == 0u ? 1u : err};\n";
  out << "}\n";
  ...
  out << "  return result.tag == ps_result_error_tag;\n";
  out << "}\n";
  ...
  out << "      : tag(activeTag), error(err), ok(value) {}\n";
  out << "};\n";
  out << "static inline ps_result_value ps_result_value_ok(uint32_t value) {\n";
  out << "  return ps_result_value{ps_result_ok_tag, 0u, value};\n";
  out << "}\n";
  out << "static inline ps_result_value ps_result_value_error(uint32_t err) {\n";
  out << "  return ps_result_value{ps_result_error_tag, err == 0u ? 1u : err, 0u};\n";
  out << "}\n";
