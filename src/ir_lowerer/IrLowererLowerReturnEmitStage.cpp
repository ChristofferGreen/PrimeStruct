    ...
    return ir_lowerer::runLowerStatementsCallsStep(
        {
            ...
            .resolveDestroyHelperForStruct = [](const std::string &) -> const Definition * { return nullptr; },
            .resolveMoveHelperForStruct = [](const std::string &) -> const Definition * { return nullptr; },
