              ...
              .consumeStage =
                  [&](ir_lowerer::LowerReturnEmitStageState &activeReturnEmitStage,
                    ...
                    auto &resolveMethodCallDefinition =
                        setupStage.inferenceSetupBootstrap.resolveMethodCallDefinition;

                    auto &emitExpr = activeReturnEmitStage.emitExpr;
                    auto &emitStatement = activeReturnEmitStage.emitStatement;
                    auto &allocTempLocal = activeReturnEmitStage.allocTempLocal;
                    auto &activeInlineContext = activeReturnEmitStage.activeInlineContext;
                    auto &inlineStack = activeReturnEmitStage.inlineStack;
                    auto &appendInstructionSourceRange =
                        activeReturnEmitStage.appendInstructionSourceRange;
                    auto &emitFileScopeCleanup = activeReturnEmitStage.emitFileScopeCleanup;
                    auto &pushFileScope = activeReturnEmitStage.pushFileScope;
                    auto &popFileScope = activeReturnEmitStage.popFileScope;
                    auto &resolveDefinitionCall = activeReturnEmitStage.resolveDefinitionCall;
                    ...
                    return ir_lowerer::runLowerStatementsCallsStage(
                        {
                            ...
                            .emitStatement = [&](const Expr &stmt, LocalMap &localsIn) {
                              return emitStatement(stmt, localsIn);
                            },
                            ...
                            .emitInlineDefinitionCall =
                                [&](const Expr &callExpr,
                                    ...
                                    const LocalMap &definitionLocals,
                                    bool expectValue) {
                                  return emitInlineDefinitionCall(
                                      callExpr, def, definitionLocals, expectValue);
                                },
                            .isTailCallCandidate =
                                ...
                                [&](const Definition &def,
                                  ...
                                  return ir_lowerer::buildCallableDefinitionCallContext(
                                      ...
                                      [&](const std::string &structPath,
                                          ir_lowerer::StructSlotLayoutInfo &layoutOut) {
                                      ...
                                      [&](const Expr &param,
                                        ...
                                        return ir_lowerer::inferCallParameterLocalInfo(
                                            param,
